...
// Blend question — letters must be tapped in order to build the word
...
export type LessonQuestion = WordStartQuestion | LetterSoundQuestion | BlendQuestion;
...
export const activities: Activity[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 'm6', kind: 'letter-sound', options: ['c', 's', 'm'], correctAnswer: 'm', phonemeFile: '/audio/phonics-units/m-sound.wav', promptFile: '/audio/prompts/which-letter-makes-the-sound.wav', hideLetter: false, skills: [SKILL_LETTER_SOUND_MAPPING] },
      { id: 'm7', kind: 'letter-sound', options: ['m', 't', 'a'], correctAnswer: 'm', phonemeFile: '/audio/phonics-units/m-sound.wav', promptFile: '/audio/prompts/which-letter-makes-the-sound.wav', hideLetter: false, skills: [SKILL_LETTER_SOUND_MAPPING] },
      ...
      { id: 'm8', kind: 'letter-sound', options: ['x', 'r', 'm'], correctAnswer: 'm', phonemeFile: '/audio/phonics-units/m-sound.wav', promptFile: '/audio/prompts/which-letter-makes-the-sound.wav', skills: [SKILL_LETTER_SOUND_MAPPING] },
      ...
      { id: 'm5', kind: 'word-start', options: ['cat', 'bat', 'mat'], correctAnswer: 'mat', phonemeFile: '/audio/phonics-units/m-sound.wav', promptFile: '/audio/prompts/which-word-starts-with-the-sound.wav', skills: [SKILL_PHONEME_IDENTIFICATION] },
    ],
  },
  {
    id: 'quiz-a',
    ...
    activityType: ActivityType.LESSON,
    questions: [
      { id: 'a4', kind: 'letter-sound', options: ['a', 'c', 'm'], correctAnswer: 'a', phonemeFile: '/audio/phonics-units/a-sound.wav', promptFile: '/audio/prompts/which-letter-makes-the-sound.wav', hideLetter: false, skills: [SKILL_LETTER_SOUND_MAPPING] },
      { id: 'a5', kind: 'letter-sound', options: ['s', 'a', 't'], correctAnswer: 'a', phonemeFile: '/audio/phonics-units/a-sound.wav', promptFile: '/audio/prompts/which-letter-makes-the-sound.wav', hideLetter: false, skills: [SKILL_LETTER_SOUND_MAPPING] },
      { id: 'a6', kind: 'letter-sound', options: ['f', 'n', 'a'], correctAnswer: 'a', phonemeFile: '/audio/phonics-units/a-sound.wav', promptFile: '/audio/prompts/which-letter-makes-the-sound.wav', hideLetter: true, skills: [SKILL_LETTER_SOUND_MAPPING] },
      { id: 'a7', kind: 'letter-sound', options: ['a', 's', 't'], correctAnswer: 'a', phonemeFile: '/audio/phonics-units/a-sound.wav', promptFile: '/audio/prompts/which-letter-makes-the-sound.wav', hideLetter: true, skills: [SKILL_LETTER_SOUND_MAPPING] },
      ...
      { id: 'a8', kind: 'word-start', options: ['cat', 'art', 'sun'], correctAnswer: 'art', phonemeFile: '/audio/phonics-units/a-sound.wav', promptFile: '/audio/prompts/which-word-starts-with-the-sound.wav', skills: [SKILL_PHONEME_IDENTIFICATION] },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 'f5', kind: 'letter-sound', options: ['f', 'm', 's'], correctAnswer: 'f', phonemeFile: '/audio/phonics-units/f-sound.wav', promptFile: '/audio/prompts/which-letter-makes-the-sound.wav', hideLetter: true, skills: [SKILL_LETTER_SOUND_MAPPING] },
      { id: 'f6', kind: 'letter-sound', options: ['t', 'f', 'n'], correctAnswer: 'f', phonemeFile: '/audio/phonics-units/f-sound.wav', promptFile: '/audio/prompts/which-letter-makes-the-sound.wav', hideLetter: true, skills: [SKILL_LETTER_SOUND_MAPPING] },
      { id: 'f7', kind: 'letter-sound', options: ['a', 'c', 'f'], correctAnswer: 'f', phonemeFile: '/audio/phonics-units/f-sound.wav', promptFile: '/audio/prompts/which-letter-makes-the-sound.wav', hideLetter: true, skills: [SKILL_LETTER_SOUND_MAPPING] },
    ],
  },
  {
    id: 'quiz-l',
    ...
    questions: [
      ...
      { id: 'l5', kind: 'letter-sound', options: ['l', 'r', 'n'], correctAnswer: 'l', phonemeFile: '/audio/phonics-units/l-sound.wav', promptFile: '/audio/prompts/which-letter-makes-the-sound.wav', hideLetter: true, skills: [SKILL_LETTER_SOUND_MAPPING] },
      { id: 'l6', kind: 'letter-sound', options: ['m', 'l', 'f'], correctAnswer: 'l', phonemeFile: '/audio/phonics-units/l-sound.wav', promptFile: '/audio/prompts/which-letter-makes-the-sound.wav', hideLetter: true, skills: [SKILL_LETTER_SOUND_MAPPING] },
      { id: 'l7', kind: 'letter-sound', options: ['s', 'l', 't'], correctAnswer: 'l', phonemeFile: '/audio/phonics-units/l-sound.wav', promptFile: '/audio/prompts/which-letter-makes-the-sound.wav', hideLetter: true, skills: [SKILL_LETTER_SOUND_MAPPING] },
    ],
  },
  {
    id: 'quiz-n',
    ...
    questions: [
      ...
      { id: 'n5', kind: 'letter-sound', options: ['n', 'm', 'r'], correctAnswer: 'n', phonemeFile: '/audio/phonics-units/n-sound.wav', promptFile: '/audio/prompts/which-letter-makes-the-sound.wav', hideLetter: true, skills: [SKILL_LETTER_SOUND_MAPPING] },
      { id: 'n6', kind: 'letter-sound', options: ['t', 'n', 's'], correctAnswer: 'n', phonemeFile: '/audio/phonics-units/n-sound.wav', promptFile: '/audio/prompts/which-letter-makes-the-sound.wav', hideLetter: true, skills: [SKILL_LETTER_SOUND_MAPPING] },
      { id: 'n7', kind: 'letter-sound', options: ['f', 'n', 'l'], correctAnswer: 'n', phonemeFile: '/audio/phonics-units/n-sound.wav', promptFile: '/audio/prompts/which-letter-makes-the-sound.wav', hideLetter: true, skills: [SKILL_LETTER_SOUND_MAPPING] },
    ],
  },
  {
    id: 'quiz-r',
    ...
    questions: [
      ...
      { id: 'r5', kind: 'letter-sound', options: ['r', 'l', 'n'], correctAnswer: 'r', phonemeFile: '/audio/phonics-units/r-sound.wav', promptFile: '/audio/prompts/which-letter-makes-the-sound.wav', hideLetter: true, skills: [SKILL_LETTER_SOUND_MAPPING] },
      { id: 'r6', kind: 'letter-sound', options: ['m', 'r', 'f'], correctAnswer: 'r', phonemeFile: '/audio/phonics-units/r-sound.wav', promptFile: '/audio/prompts/which-letter-makes-the-sound.wav', hideLetter: true, skills: [SKILL_LETTER_SOUND_MAPPING] },
      { id: 'r7', kind: 'letter-sound', options: ['s', 'r', 't'], correctAnswer: 'r', phonemeFile: '/audio/phonics-units/r-sound.wav', promptFile: '/audio/prompts/which-letter-makes-the-sound.wav', hideLetter: true, skills: [SKILL_LETTER_SOUND_MAPPING] },
    ],
  },
  {
    id: 'quiz-s',
    ...
    questions: [
      ...
      { id: 's3', kind: 'word-start', options: ['sip', 'tip', 'lip'], correctAnswer: 'sip', phonemeFile: '/audio/phonics-units/s-sound.wav', promptFile: '/audio/prompts/which-word-starts-with-the-sound.wav', skills: [SKILL_PHONEME_IDENTIFICATION] },
      { id: 's4', kind: 'word-start', options: ['sock', 'rock', 'lock'], correctAnswer: 'sock', phonemeFile: '/audio/phonics-units/s-sound.wav', promptFile: '/audio/prompts/which-word-starts-with-the-sound.wav', skills: [SKILL_PHONEME_IDENTIFICATION] },
      { id: 's5', kind: 'letter-sound', options: ['s', 'c', 'm'], correctAnswer: 's', phonemeFile: '/audio/phonics-units/s-sound.wav', promptFile: '/audio/prompts/which-letter-makes-the-sound.wav', hideLetter: true, skills: [SKILL_LETTER_SOUND_MAPPING] },
      { id: 's6', kind: 'letter-sound', options: ['t', 's', 'n'], correctAnswer: 's', phonemeFile: '/audio/phonics-units/s-sound.wav', promptFile: '/audio/prompts/which-letter-makes-the-sound.wav', hideLetter: true, skills: [SKILL_LETTER_SOUND_MAPPING] },
      { id: 's7', kind: 'letter-sound', options: ['f', 's', 'a'], correctAnswer: 's', phonemeFile: '/audio/phonics-units/s-sound.wav', promptFile: '/audio/prompts/which-letter-makes-the-sound.wav', hideLetter: true, skills: [SKILL_LETTER_SOUND_MAPPING] },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 'h5', kind: 'letter-sound', options: ['h', 'm', 's'], correctAnswer: 'h', phonemeFile: '/audio/phonics-units/h-sound.wav', promptFile: '/audio/prompts/which-letter-makes-the-sound.wav', hideLetter: true, skills: [SKILL_LETTER_SOUND_MAPPING] },
      { id: 'h6', kind: 'letter-sound', options: ['t', 'h', 'n'], correctAnswer: 'h', phonemeFile: '/audio/phonics-units/h-sound.wav', promptFile: '/audio/prompts/which-letter-makes-the-sound.wav', hideLetter: true, skills: [SKILL_LETTER_SOUND_MAPPING] },
      { id: 'h7', kind: 'letter-sound', options: ['f', 'r', 'h'], correctAnswer: 'h', phonemeFile: '/audio/phonics-units/h-sound.wav', promptFile: '/audio/prompts/which-letter-makes-the-sound.wav', hideLetter: true, skills: [SKILL_LETTER_SOUND_MAPPING] },
    ],
  },
  {
